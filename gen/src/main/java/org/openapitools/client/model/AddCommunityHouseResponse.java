...
public class AddCommunityHouseResponse {
  ...
  private Set<String> houses = new LinkedHashSet<String>();


  public AddCommunityHouseResponse houses(Set<String> houses) {
    
    this.houses = houses;
    return this;
  }

  public AddCommunityHouseResponse addHousesItem(String housesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AddCommunityHouseResponse addCommunityHouseResponse = (AddCommunityHouseResponse) o;
    return Objects.equals(this.houses, addCommunityHouseResponse.houses);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddCommunityHouseResponse {\n");
