...
public class HouseController implements HousesApi {
  ...
  @Override
  public ResponseEntity<ListHouseMembersResponse> listAllMembersOfHouse(String houseId,
      Pageable pageable) {
  ...
  @Override
  public ResponseEntity<AddHouseMemberResponse> addHouseMembers(String houseId,
      AddHouseMemberRequest request) {
